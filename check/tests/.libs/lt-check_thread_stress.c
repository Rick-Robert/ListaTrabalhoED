...
/* ./.libs/lt-check_thread_stress.c - temporary wrapper executable for .libs/check_thread_stress.exe
   Generated by libtool (GNU libtool) 2.4.6

   The check_thread_stress program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "check_thread_stress.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# check_thread_stress - temporary wrapper script for .libs/check_thread_stress.", f);
  fputs ("exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The check_thread_stress program cannot be directly executed until all the lib", f);
  fputs ("tool\n", f);
  ...
  fputs ("    echo \"check_thread_stress.exe:check_thread_stress:$LINENO: libtool wrapper ", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"check_thread_stress.exe:check_thread_stress:$LINENO: newargv[$lt_dum", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"check_thread_stress.exe:check_thread_stress:$LINENO: newargv[0]:", f);
  ...
  fputs ("\n", f);
  fputs ("  program='check_thread_stress.exe'\n", f);
