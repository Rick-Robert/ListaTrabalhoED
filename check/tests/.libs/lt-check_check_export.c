...
/* ./.libs/lt-check_check_export.c - temporary wrapper executable for .libs/check_check_export.exe
   Generated by libtool (GNU libtool) 2.4.6

   The check_check_export program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "check_check_export.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# check_check_export - temporary wrapper script for .libs/check_check_export.ex", f);
  fputs ("e\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The check_check_export program cannot be directly executed until all the libt", f);
  fputs ("ool\n", f);
  ...
  fputs ("    echo \"check_check_export.exe:check_check_export:$LINENO: libtool wrapper (G", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"check_check_export.exe:check_check_export:$LINENO: newargv[$lt_dump_", f);
  fputs ("args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"check_check_export.exe:check_check_export:$LINENO: newargv[0]: $", f);
  ...
  fputs ("\n", f);
  fputs ("  program='check_check_export.exe'\n", f);
