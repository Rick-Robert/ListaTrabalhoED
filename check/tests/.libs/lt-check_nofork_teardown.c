...
/* ./.libs/lt-check_nofork_teardown.c - temporary wrapper executable for .libs/check_nofork_teardown.exe
   Generated by libtool (GNU libtool) 2.4.6

   The check_nofork_teardown program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = ""C:\\Users\\tubel\\Desktop\\C++Programs\\C programs\\SQTPM\\Trabalho\\check\\src\\.libs";";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "\\c\\Users\\tubel\\Desktop\\C++Programs\\C:programs\\SQTPM\\Trabalho\\check\\src\\.libs:\\mingw64\\lib:\\mingw64\\bin;";
const char * TARGET_PROGRAM_NAME = "check_nofork_teardown.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# check_nofork_teardown - temporary wrapper script for .libs/check_nofork_teard", f);
  fputs ("own.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The check_nofork_teardown program cannot be directly executed until all the l", f);
  fputs ("ibtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../src/libcheck.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"check_nofork_teardown.exe:check_nofork_teardown:$LINENO: libtool wrap", f);
  fputs ("per (GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"check_nofork_teardown.exe:check_nofork_teardown:$LINENO: newargv[$lt", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"check_nofork_teardown.exe:check_nofork_teardown:$LINENO: newargv", f);
  ...
  fputs ("\n", f);
  fputs ("  program='check_nofork_teardown.exe'\n", f);
  ...
  fputs ("    PATH=/c/Users/tubel/Desktop/C++Programs/C:programs/SQTPM/Trabalho/check/src", f);
  fputs ("/.libs:/mingw64/lib:/mingw64/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/c/Users/tubel/Desktop/C++Programs/C programs/SQTPM/Trabalho/check/sr", f);
  fputs ("c/.libs:$PATH\"\n", f);
  fputs ("\n", f);
