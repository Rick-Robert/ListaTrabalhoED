...
/* ./.libs/lt-check_set_max_msg_size.c - temporary wrapper executable for .libs/check_set_max_msg_size.exe
   Generated by libtool (GNU libtool) 2.4.6

   The check_set_max_msg_size program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "check_set_max_msg_size.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# check_set_max_msg_size - temporary wrapper script for .libs/check_set_max_msg", f);
  fputs ("_size.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The check_set_max_msg_size program cannot be directly executed until all the ", f);
  fputs ("libtool\n", f);
  ...
  fputs ("    echo \"check_set_max_msg_size.exe:check_set_max_msg_size:$LINENO: libtool wr", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"check_set_max_msg_size.exe:check_set_max_msg_size:$LINENO: newargv[$", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"check_set_max_msg_size.exe:check_set_max_msg_size:$LINENO: newar", f);
  ...
  fputs ("\n", f);
  fputs ("  program='check_set_max_msg_size.exe'\n", f);
