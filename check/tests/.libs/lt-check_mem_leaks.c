...
/* ./.libs/lt-check_mem_leaks.c - temporary wrapper executable for .libs/check_mem_leaks.exe
   Generated by libtool (GNU libtool) 2.4.6

   The check_mem_leaks program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "check_mem_leaks.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# check_mem_leaks - temporary wrapper script for .libs/check_mem_leaks.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The check_mem_leaks program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"check_mem_leaks.exe:check_mem_leaks:$LINENO: libtool wrapper (GNU lib", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"check_mem_leaks.exe:check_mem_leaks:$LINENO: newargv[$lt_dump_args_N", f);
  fputs ("]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"check_mem_leaks.exe:check_mem_leaks:$LINENO: newargv[0]: $progdi", f);
  fputs ("r/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='check_mem_leaks.exe'\n", f);
