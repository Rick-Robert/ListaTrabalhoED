...
/* ./.libs/lt-check_stress.c - temporary wrapper executable for .libs/check_stress.exe
   Generated by libtool (GNU libtool) 2.4.6

   The check_stress program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "check_stress.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# check_stress - temporary wrapper script for .libs/check_stress.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The check_stress program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"check_stress.exe:check_stress:$LINENO: libtool wrapper (GNU libtool) ", f);
  fputs ("2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"check_stress.exe:check_stress:$LINENO: newargv[$lt_dump_args_N]: $lt", f);
  fputs ("_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"check_stress.exe:check_stress:$LINENO: newargv[0]: $progdir/$pro", f);
  fputs ("gram\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='check_stress.exe'\n", f);
